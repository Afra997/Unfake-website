...
function renderAdminFeedPosts(posts) {
    ...
    posts.forEach(post => {
        ...
        postElement.innerHTML = `
            ...
            <p class="text-sm font-medium">
                Current Flag: <strong class="${flagClass}">${post.adminFlag}</strong>
            ...
            <div class="flag-reason-box hidden mt-3" data-post-id="${post._id}">
                <textarea class="w-full p-2 border border-gray-300 rounded-lg mb-2" rows="2" placeholder="Add or update reason...">${post.adminReason || ''}</textarea>
    ...
    addShowReasonListeners(); // <-- We also call our new listener function here
}
